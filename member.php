  ...
  <div id="admin" class="col s12">
    <div class="card material-table">
      <div class="table-header">
        <span class="table-title">Country List (All)</span>
      ...
      <table id="datatable">
        ...
        for ($i=0; $i < $array_len; $i++) { 
          ...
          for ($a=0; $a < $fav_size; $a++) { 
              ...
              {
              ?>
              <form id="addfav" name="addfav" method="post" action="server/add_fav.php">
                ...
                <input type="submit" class="btn-sm btn-primary" value="Add to Favorites">
              </form>
              <?php
            } else {
             ?>
             <button class="btn-sm btn-danger">Favorite</button>
             <?php                    
            }
            echo "</td></tr>";   
        }
